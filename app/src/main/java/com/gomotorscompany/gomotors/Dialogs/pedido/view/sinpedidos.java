package com.gomotorscompany.gomotors.Dialogs.pedido.view;
...
public class sinpedidos extends DialogFragment  implements View.OnClickListener {
    public static final String TAG = sinpedidos.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sin_pedidos, container, false);
