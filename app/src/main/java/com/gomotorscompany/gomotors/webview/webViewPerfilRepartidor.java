...
public class webViewPerfilRepartidor extends AppCompatActivity {
    public static final String TAG = webViewPerfilRepartidor.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myWebView.loadUrl("http://gomosystem-001-site3.etempurl.com/MODULOS/funcion?cve_objeto=M_W01_030&&token="+token);
        Log.e("consultaWEb","http://gomosystem-001-site3.etempurl.com/MODULOS/funcion?cve_objeto=M_W01_030&&token="+token);
