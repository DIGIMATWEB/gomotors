...
public class sucursales {
    ...
    @Expose
    private List<Clasificacione> clasificaciones = null;

    public sucursales(String codigoSucursal,String sucursalNombre,Integer idSucursal,String sucursalLat,String sucursalLong,String sucursalApertura,String sucursalCierre, List<Clasificacione> clasificaciones)
    {
    ...
    public void setClasificaciones(List<Clasificacione> clasificaciones) {
        this.clasificaciones = clasificaciones;
    }
