...
public class webViewTickets extends AppCompatActivity  {
    public static final String TAG = webViewTickets.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myWebView.loadUrl("http://200.92.216.34:83/MODULOS/funcion?cve_objeto=M_W01_035&&token="+token);
        Log.e("consultaWEb","http://200.92.216.34:83/MODULOS/funcion?cve_objeto=M_W01_035&&token="+token);
